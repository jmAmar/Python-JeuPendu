...
class gestion_scores():
  ...
  def extraire(self, joueur, fichierScores="scores_joueurs.txt"):
    ...
    self.joueur = joueur
    # instancie l'objet fchTexte la classe Fichier_Texte du module gestion_fichiers_v1_SRC
    fchTexte = mdlGF.Fichier_Texte()
    # assigne le nom du fichier texte des scores à l'objet fchTexte (avec sa méthode "assigner")
