...
import gestion_scores_SRC_v1 as mdlSS
...
def enregistrer_dictionnaire(dico):
  # instancie l'objet fchTexte de la classe Fichier_Texte du module gestion_fichiers_SRC_v2
...
def extraire_score(joueur):
  # instancie l'objet gestionScores de la classe Gestion_Scores du module gestion_SRC_v1
